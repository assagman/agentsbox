...
describe("AgentsboxPlugin", () => {
  test("exports a plugin function", () => {
    expect(typeof AgentsboxPlugin).toBe("function");
  });
  ...
  test("returns core tools when config is valid", async () => {
    ...
    expect(hooks.tool?.agentsbox_search_bm25).toBeDefined();
    expect(hooks.tool?.agentsbox_search_regex).toBeDefined();
    expect(hooks.tool?.agentsbox_execute).toBeDefined();
    expect(hooks.tool?.agentsbox_status).toBeDefined();

    delete process.env.AGENTSBOX_CONFIG;
  });
});

describe("agentsbox_search_bm25 schema", () => {
  let bm25Tool: any;
  ...
  beforeEach(async () => {
    ...
    const hooks = await AgentsboxPlugin(createMockPluginInput());
    bm25Tool = hooks.tool?.agentsbox_search_bm25;
  });
...
describe("agentsbox_search_regex schema", () => {
  let regexTool: any;
  ...
  beforeEach(async () => {
    ...
    const hooks = await AgentsboxPlugin(createMockPluginInput());
    regexTool = hooks.tool?.agentsbox_search_regex;
  });
...
describe("agentsbox_execute schema", () => {
  let executeTool: any;
  ...
  beforeEach(async () => {
    ...
    const hooks = await AgentsboxPlugin(createMockPluginInput());
    executeTool = hooks.tool?.agentsbox_execute;
  });

  test("has description with usage info", () => {
    expect(executeTool.description).toContain("agentsbox_search_bm25");
...
describe("agentsbox_search_bm25 execute", () => {
  let bm25Tool: any;
...
describe("agentsbox_search_regex execute", () => {
  let regexTool: any;
...
describe("agentsbox_execute execute", () => {
  let executeTool: any;
...
describe("agentsbox_status schema", () => {
  let statusTool: any;
  ...
  beforeEach(async () => {
    ...
    const hooks = await AgentsboxPlugin(createMockPluginInput());
    statusTool = hooks.tool?.agentsbox_status;
  });
...
describe("agentsbox_status execute", () => {
  let statusTool: any;
