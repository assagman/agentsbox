...
This document describes the automated release process for agentsbox.
...
| Check | URL |
|-------|-----|
| npm package | https://www.npmjs.com/package/agentsbox |
| GitHub Release | https://github.com/assagman/agentsbox/releases |
| Git tags | `git tag -l` |
...
- For problematic releases, deprecate the npm version: `npm deprecate agentsbox@X.Y.Z "Reason for deprecation"`
