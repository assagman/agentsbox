...
### Added
- **agentsboxTools in status**: `agentsbox_status` now includes array of toolbox's own 6 tools for visibility
- **Auto-update command file**: `/agentsbox-status` slash command file now auto-updates when content changes
...
### Documentation
- Updated `agentsbox_status` example output with new fields (initState, initMode, initDurationMs, commandString, url, agentsboxTools)
...
- **Auto-create config**: Plugin automatically creates `~/.config/agentsbox/config.jsonc` with schema reference on first run
...
### Breaking Changes
- **`agentsbox_execute` parameter renamed**: `name` → `toolId` for clarity
  - Old: `agentsbox_execute({ name: "time_get_current_time", ... })`
  - New: `agentsbox_execute({ toolId: "time_get_current_time", ... })`
...
- Added `{serverName}_{toolName}` format documentation to `agentsbox_execute` description
...
### Added
- **Test tool**: New `agentsbox_test` tool for testing all MCP tools with predefined minimal prompts
...
- MCP servers still connect in background, tools available via `agentsbox_search_*` once ready
...
- **Performance tool**: New `agentsbox_perf` tool for detailed performance metrics
...
- Added `agentsbox_perf` documentation
...
- **Status Tool**: New `agentsbox_status` tool for checking plugin and server health
- **Slash Command**: Auto-creates `/agentsbox-status` command on first launch
...
- **Tests**: Comprehensive test suite for `agentsbox_status` tool (9 new tests)

### Changed
- Updated README with observability section and logging documentation
- Added troubleshooting guidance using `agentsbox_status` and logs
...
### Changed
- Updated README and ARCHITECTURE docs to reflect three-tool structure (`agentsbox_search_bm25`, `agentsbox_search_regex`, `agentsbox_execute`)
...
- Tool names now use clear `<server>_<tool>` format matching agentsbox_execute() expectations
...
- MCP server exposing agentsbox_search_regex and agentsbox_search_bm25
...
[Unreleased]: https://github.com/assagman/agentsbox/compare/v0.10.2...HEAD
[0.10.2]: https://github.com/assagman/agentsbox/compare/v0.10.1...v0.10.2
[0.10.1]: https://github.com/assagman/agentsbox/compare/v0.10.0...v0.10.1
[0.10.0]: https://github.com/assagman/agentsbox/compare/v0.9.0...v0.10.0
[0.9.0]: https://github.com/assagman/agentsbox/compare/v0.8.0...v0.9.0
[0.8.0]: https://github.com/assagman/agentsbox/compare/v0.7.0...v0.8.0
[0.7.0]: https://github.com/assagman/agentsbox/compare/v0.6.0...v0.7.0
[0.6.0]: https://github.com/assagman/agentsbox/compare/v0.5.1...v0.6.0
[0.5.1]: https://github.com/assagman/agentsbox/compare/v0.5.0...v0.5.1
[0.5.0]: https://github.com/assagman/agentsbox/compare/v0.4.0...v0.5.0
[0.4.0]: https://github.com/assagman/agentsbox/compare/v0.3.1...v0.4.0
[0.3.1]: https://github.com/assagman/agentsbox/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/assagman/agentsbox/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/assagman/agentsbox/releases/tag/v0.2.0
